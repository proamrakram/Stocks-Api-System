<x-layout-ar>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="table-responsive">
            ...
            {{-- @endif --}}
            {{-- <h1 style="margin-top: 10px;" >أسعار الأسهم</h1> --}}
            <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr class="textCenter">
                    <td>{{ $x }}</td>
                    <td class="gainers"><a target="_blank" href="{{route('getStock', $stock->symbol)}}">{{$stock->symbol}}</a></td>
